...
<table class="form-table" role="presentation">
	<tbody>
		...
		<tr class="license-key-wrap">
			...
			<td><input type="text" name="license_key" id="license_key" value="<?php echo esc_attr( $license_key ); ?>" class="large-text"> <span class="description">Any key to activate this asset like purchase key, token etc. Use '|' without sinqle quote to add multiple purchase keys.</span></td>
		</tr>

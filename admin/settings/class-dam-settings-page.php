...
class DAM_Settings_Page {
	...
	public function dam_register_settings() {
		...
		// Asset Tags taxonomy  Settings.
		add_settings_section(
			'dam_asset_tags_taxonomy_section',
			esc_html__( 'Asset Tags Taxonomy', 'digital-asset-manager' ),
			array( $this, 'dam_asset_tags_taxonomy_section_description' ),
			'dam-settings'
		);

		add_settings_field(
			'asset_tags_taxonomy_visibility',
			esc_html__( 'Visibility', 'digital-asset-manager' ),
			array( $this, 'myplugin_callback_field_radio' ),
			'dam-settings',
			'dam_asset_tags_taxonomy_section',
			array(
				'id'   => 'asset_tags_taxonomy_visibility',
				'desc' => esc_html__( 'Set the visibility for asset tags taxonomy.', 'digital-asset-manager' ),
			)
		);
	...
	/**
	 * Asset Tags Taxonomy Section Description.
	 *
	 * @return void
	 */
	public function dam_asset_tags_taxonomy_section_description() {
		echo '<p>' . esc_html__( 'Configure settings for asset tags taxonomy.', 'digital-asset-manager' ) . '</p>';
	}
	...
	public function dam_return_setting_fields_options( $key ) {
		...
		$options = array(
			...
			'asset_tags_taxonomy_visibility' => array(
				'public'  => 'Public',
				'private' => 'Private',
			),
		);

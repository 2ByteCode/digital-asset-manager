...
class Digital_Asset_Manager {
	...
	private function load_dependencies() {
		...
		require_once DAM_ADMIN_PATH . 'taxonomies/class-dam-taxonomy-asset-tags.php';
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'manage_dam-asset_posts_columns', $post_type_assets, 'dam_manage_asset_table_columns', 99, 1 );
		$this->loader->add_filter( 'manage_dam-asset_posts_custom_column', $post_type_assets, 'dam_manage_asset_table_custom_columns', 99, 2 );
		$this->loader->add_filter( 'post_column_taxonomy_links', $post_type_assets, 'dam_manage_asset_token_column', 99, 3 );
		...
		$taxonomy_asset_tags = new DAM_Taxonomy_Asset_Tags();
		$this->loader->add_action( 'init', $taxonomy_asset_tags, 'dam_taxonomy_asset_tags', 11 );
